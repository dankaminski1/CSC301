...
public class RJUnitTiming {
	private static final int SIZE = 10000;
	private static final long DIFF = 200;

	private static RSequentialSearchST<String, Integer> putSmall;
	private static RSequentialSearchST<String, Integer> putLarge;
	private static RSequentialSearchST<String, Integer> getSmall;
	private static RSequentialSearchST<String, Integer> getLarge;
	private static RSequentialSearchST<String, Integer> delSmall;
	private static RSequentialSearchST<String, Integer> delLarge;
	...
	public static void setupNumbers() {
		putSmall = new RSequentialSearchST<String, Integer>();
		putLarge = new RSequentialSearchST<String, Integer>();
		getSmall = new RSequentialSearchST<String, Integer>();
		getLarge = new RSequentialSearchST<String, Integer>();
		delSmall = new RSequentialSearchST<String, Integer>();
		delLarge = new RSequentialSearchST<String, Integer>();
		putSmall.put("0", 0);
		putSmall.put("1", 1);
		getSmall.put("0", 0);
		getSmall.put("1", 1);
